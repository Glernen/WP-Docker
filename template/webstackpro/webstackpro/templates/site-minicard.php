            ...
            <a href="<?php echo $url ?>" <?php echo $blank ?> data-id="<?php echo $post->ID ?>" data-url="<?php echo rtrim($link_url,"/") ?>" class="card <?php echo $is_views ?> mb-3 site-<?php echo $post->ID ?>" <?php echo $tooltip . ' ' . $is_html ?> title="<?php echo $title ?>">
                ...
                <div class="url-content">
                    <div class="url-img">
                        ...
                        <img class="rounded-circle lazy" src="<?php echo $default_ico; ?>" data-src="<?php echo $ico ?>" onerror="javascript:this.src='<?php echo $default_ico; ?>'" width="25" height="25">
                        <?php else: ?>
                        <img class="rounded-circle lazy" src="<?php echo $ico ?>" onerror="javascript:this.src='<?php echo $default_ico; ?>'" width="25" height="25">
                        <?php endif ?>
                    </div>
