...
(function($){ 
    ...
    function getList(_type){
        ...
        $.get("https://raw.fastgit.org/typeofNaN/hot/master/weibo-hot-search/2021-04-30.json",function(res,data,status){ 
            res.set({'Access-Control-Allow-Origin': 'http://10.1.10.68:80'}) 
            let html = '';
